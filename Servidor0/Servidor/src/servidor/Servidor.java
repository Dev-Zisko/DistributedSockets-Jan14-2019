...
public class Servidor {
    ...
    public static void main(String[] args) throws IOException {
      ...
      //Se crean los serversockets
        ...
        if(entre==0){
            try {
                Socket socket10 = new Socket("192.168.0.102",10001);
            ...
            try {
                Socket socket10 = new Socket("192.168.0.102",10002);
                if(socket10.isBound() && encontre == 0){
                    idactual = 2;
                    rol = idactual;
                    encontre = 1;
                ...
                System.out.println("El servidor 2 no esta activo.");
            }
            try {
                Socket socket10 = new Socket("192.168.0.102",10003);
                if(socket10.isBound() && encontre == 0){
                    idactual = 3;
                    rol = idactual;
                    encontre = 1;
        ...
        try {
            ...
            socketS = new ServerSocket(10000);
            ...
            while (true) {
                ...
                try {
                    if(rol==1){
                        ...
                        Socket socket1 = new Socket("192.168.0.102",10001);
                        System.out.println("Conectado correctamente al servidor principal.");
                        ...
                        Socket socket1 = new Socket("192.168.0.102",10002);
                        System.out.println("Conectado correctamente al servidor principal.");
                        DataOutputStream dos11 = new DataOutputStream(socket1.getOutputStream());
                        dos11.writeUTF("030|"+id);
                        System.out.println("030-Envio de id de estado de conexion.");                       
                        ...
                        idactual = 3;
                        Socket socket = new Socket("192.168.0.102",10003);
                        System.out.println("Conectado correctamente al servidor principal.");
                        DataOutputStream dos1 = new DataOutputStream(socket.getOutputStream());
                        int idarchivo = control.buscarArchivo();
                        dos1.writeUTF("003|"+Integer.toString(idarchivo));
                        ...
                        Socket socket1 = new Socket("192.168.0.102",10003);
                        System.out.println("Conectado correctamente al servidor principal.");
                        DataOutputStream dos11 = new DataOutputStream(socket1.getOutputStream());
                        dos11.writeUTF("030|"+id);
                        System.out.println("030-Envio de id de estado de conexion.");                       
