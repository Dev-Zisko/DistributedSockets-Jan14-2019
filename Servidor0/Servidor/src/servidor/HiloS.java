...
public class HiloS extends Thread{
    ...
    public HiloS(Socket socket, int id) {
        this.socket = socket;
        this.idSessio = id;
        try {
            ...
            if(parts[0].equals("030")){
                control.setearEstado1(Integer.parseInt(parts[1]));
                ArrayList<Servidor> listaServidor = control.buscarTodosServidores();
                ObjectOutputStream salida1 = null;
                salida1 = new ObjectOutputStream(socket.getOutputStream());
                salida1.writeObject(listaServidor);
                salida1.close();
            }
            ...
            if(parts[0].equals("003")){
                ...
                if(idant<idarchivo){
                    ...
                    String mensaje1 = control.buscarPathArchivo(idant+1);
                    ...
                    if(!mensaje1.equals("")){
                        ...
                        try
                        {
                            ...
                            System.err.println("Error al buscar archivo a replicar. "+e);
                        }
                        idant = idarchivo;
                    }
                    else{
